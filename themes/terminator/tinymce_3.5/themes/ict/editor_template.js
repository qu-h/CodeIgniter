(function(tinymce) {
	...
	tinymce.ThemeManager.requireLangPack('ict');

	tinymce.create('tinymce.themes.ICTTheme', {
		...
		init : function(ed, url) {
			...
			t.settings = s = extend({
				...
				theme_advanced_buttons1	:"bold,italic,underline,strikethrough,"
										...
										+"|,fontsizeselect,forecolor,backcolor,|,ictlink,unlink,ictimage",
...
//					return this._createIctImage();
	...
	tinymce.ThemeManager.add('ict', tinymce.themes.ICTTheme);
}(tinymce));
